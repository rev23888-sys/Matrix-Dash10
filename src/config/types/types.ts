...
/**
 * FeaturesConfig maps feature IDs to their UI config.
 * Using Partial so you only need to define the features you want
 * visible in the dashboard — any omitted key is simply hidden.
 */
